...
Set up your `.env` file in the **project root directory** with your OpenAI and Anthropic API keys (see API Configuration section below).
...
3. Save the `.env` file (it's already in `.gitignore` for security)

### Why Both APIs?
- **OpenAI GPT-4**: Powers the conversational workflow planning
- **Claude 4.5 Sonnet**: Generates production-ready n8n JSON workflows
